...
**ID format:** `[CATEGORY]-[NUMBER]` (e.g., `MATA-01`, `FINA-03`, `REST-02`)
...
- [ ] [Measurable outcome - e.g., "User can complete X without errors"]
- [ ] [Measurable outcome - e.g., "Zero compilation errors after encoding conversion"]
```
